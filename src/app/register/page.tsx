    ...
    <div className="min-h-screen bg-background flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-secondary relative overflow-hidden items-center justify-center">
        ...
        <div className="relative z-10 text-center px-12">
          ...
          <h2 className="text-4xl font-black text-foreground mb-4 leading-tight">
            Join the<br />HomeVibe family.
          </h2>
          <p className="text-muted-foreground text-lg">
            Create your account and start building the home of your dreams with bold, quality pieces.
          </p>
          <div className="mt-10 space-y-4 text-left">
            {[
              { icon: 'CheckCircleIcon', text: 'Free shipping on orders over KSh 15,000' },
              { icon: 'CheckCircleIcon', text: 'Easy 30-day returns' },
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-md">
          ...
          <p className="text-muted-foreground mb-8">Join HomeVibe and transform your space.</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <label className="block text-sm font-bold text-foreground mb-2">
                Phone Number <span className="text-muted-foreground font-normal">(for order updates)</span>
              </label>
